...
func flags() (string, error) {
	...
	return fmt.Sprintf(`-X "github.com/ninjawule/gnorm/cli.timestamp=%s" -X "github.com/ninjawule/gnorm/cli.commitHash=%s" -X "github.com/ninjawule/gnorm/cli.version=%s"`, timestamp, hash, version), nil
}
